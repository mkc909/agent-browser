...
```bash
export AGENT_BROWSER_AI_GATEWAY_URL=https://ai-gateway.vercel.sh   # this is the default
export AGENT_BROWSER_AI_MODEL=openai/gpt-4o-mini                   # default: anthropic/claude-haiku-4.5
```
...
<table>
  ...
  <tbody>
    <tr><td><code>AGENT_BROWSER_AI_GATEWAY_URL</code></td><td>Vercel AI Gateway base URL.</td><td><code>https://ai-gateway.vercel.sh</code></td></tr>
    <tr><td><code>AGENT_BROWSER_AI_API_KEY</code></td><td>API key for the AI Gateway. Required to enable AI chat responses.</td><td>(none)</td></tr>
    <tr><td><code>AGENT_BROWSER_AI_MODEL</code></td><td>Default AI model for chat requests.</td><td><code>anthropic/claude-haiku-4.5</code></td></tr>
  </tbody>
</table>
