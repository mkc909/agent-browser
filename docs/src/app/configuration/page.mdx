...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>AGENT_BROWSER_AI_API_KEY</code></td><td>API key for the Vercel AI Gateway. Required to enable AI chat.</td><td>(none)</td></tr>
    <tr><td><code>AGENT_BROWSER_AI_MODEL</code></td><td>Default AI model for dashboard chat.</td><td><code>anthropic/claude-haiku-4.5</code></td></tr>
  </tbody>
</table>
